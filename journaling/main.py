...
Your mindset is like the operating system of your brain, and can be improved.
...
Inversion:
    Practicing a reaction to a situation looking at it from the solution, and the opposite of the solution.

Persepctive:
    Approach the issue as if you are observing it as your friend. What advice would you give?.
